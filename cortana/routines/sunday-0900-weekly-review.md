...
TIME BUDGET: hard ceiling, 15 minutes of elapsed time. Check the clock at every step boundary, not just at the end. The moment elapsed time passes the ceiling, stop all gathering and all calendar work and call send_message immediately with what you already have. On Sep 13 the Sunday review ran 86 minutes against a 15 minute ceiling; a late brief that names the right day is still worth far more than a perfect one nobody reads in time. Essential steps first. If the clock passes 15 minutes, stop gathering and send what you have.
